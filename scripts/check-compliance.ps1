...
$checks = @(
  ...
  @{ Path = "skills\od\engine\interactive-prompt.md"; Need = @('STOP', 'WAIT', 'AskQuestion', 'phase0_s_fastpath', 'Decision Matrix', 'deploy_consent', 'Pseudo-Popup', 'codex_auto_resolve', 'allow_auto_resolve') },
