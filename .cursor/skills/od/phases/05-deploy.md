...
- [ ] All **Required** test layers executed per `05-test-plan.md` frontmatter (UNIT mandatory; E2E if fullstack)
...
If `06-release-notes.md` exists for a prior release on this branch, archive to `06-release-notes-history.md` before writing new release ([document-history.md](../engine/document-history.md)).
...
history_ref: 06-release-notes-history.md
