...
| State files | `02-plan.md`, `03-progress.md`, `00-project-context.md` | ⚠️ Section-only | Load **active** slices per [context-occupancy.md](context-occupancy.md) §4–§5; never load `*-history.md` in normal phases |
...
4. Forbidden: loading `*-history.md` full snapshots during Phase 0–5 (except `/od ch` diff or user request)
...
| **COLD** | unlimited on disk | features/, test plan, blueprint, tool raw, **`*-history.md`** |
