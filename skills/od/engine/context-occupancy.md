...
| HOT | 指令 + 当前 feature 测试表 + 1 个 TC 执行结果 | 120 |
| WARM | 02-plan traceability 行 + smoke 汇总表 | 60 |
| COLD | 其他 feature 测试表、coverage raw、test log | — |
...
| 4 | `AI Pitfall Guide`, test conventions line |
...
In addition to progress archive ([special-flows.md](special-flows.md) §4):
